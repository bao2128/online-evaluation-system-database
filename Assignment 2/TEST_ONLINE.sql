...
--tạo database tên TEST_ONLINE_02
CREATE DATABASE TEST_ONLINE_02
GO
USE TEST_ONLINE_02
GO
...
(
	ID_NV_GUI_YC	VARCHAR(10) NOT NULL,
	ID_NV_NHAN_YC	VARCHAR(10) NOT NULL,
	Noi_dung	NVARCHAR(100) NOT NULL,
	Trang_thai	NVARCHAR(100) NOT NULL,
